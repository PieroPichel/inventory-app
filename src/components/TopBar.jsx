      ...
      try {
        ...
        const links = await databases.listDocuments(
          ...
          [
            ...
            Query.equal("houseId", currentHouse.$id),
          ]
        );

        if (links.total > 0 && links.documents[0].role === "owner") {
          setIsOwner(true);
        } else {
          setIsOwner(false);
        }
              ...
              <div style={menuDropdown}>
                ...
                {isOwner && (
                  <button
                    style={menuItem}
                    onClick={() =>
                      handleMenuAction(() => navigate("/manage"))
                    }
                  >
                    Manage House
                  </button>
...
const menuDropdown = {
  ...
  top: "110%",
  background: "#222",
  border: "1px solid #444", // ← FIXED HERE
  borderRadius: "8px",
  padding: "8px 0",
  minWidth: "180px",
  zIndex: 1000,
